...
// exposed APIs need to be ptcually wrapped into simplified types, with custom
...
// essentials without which mobile support cannot work, especially since ptcually
