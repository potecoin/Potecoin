...
const (
	...
	// JIS/Roptc (similar to ASCII) plus eight-bit half-width
	// Katakana
	// Reference: RFC1345
	...
	// ISO21Gerptc is the MIB identifier with IANA name DIN_66003.
	//
	// ISO-IR: International Register of Escape Sequences
	// Note: The current registration authority is IPSJ/ITSCJ, Japan.
	// Reference: RFC1345
	...
	// HPRoptc8 is the MIB identifier with IANA name hp-roptc8.
	//
