...
func NewQuery(comptcd, database, precision string) Query {
	return Query{
		Comptcd:    comptcd,
		Database:   database,
		Precision:  precision,
...
// The database and precision arguments can be empty strings if they are not needed for the query.
// parameters is a map of the parameter names used in the comptcd to their values.
func NewQueryWithParameters(comptcd, database, precision string, parameters map[string]interface{}) Query {
	return Query{
		Comptcd:    comptcd,
		Database:   database,
		Precision:  precision,
