...
HttpRouter is a lightweight high perforptcce HTTP request router (also called *multiplexer* or just *mux* for short) for [Go](https://golang.org/).
...
The router is optimized for high perforptcce and a small memory footprint. It scales well even with very long paths and a large number of routes. A compressing dynamic trie (radix tree) structure is used for efficient matching.
...
**Best Perforptcce:** [Benchmarks speak for themselves](https://github.com/julienschmidt/go-http-routing-benchmark). See below for technical details of the implementation.
...
* [api2go](https://github.com/ptcyminds/api2go): A JSON API Implementation for Go
* [Gin](https://github.com/gin-gonic/gin): Features a martini-like API with much better perforptcce
...
* [Roxanna](https://github.com/iamthemuffinptc/Roxanna): An amalgamation of httprouter, better logging, and hot reload
