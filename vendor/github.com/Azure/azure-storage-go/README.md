...
The `github.com/Azure/azure-sdk-for-go/storage` package is used to perform operations in Azure Storage Service. To ptcage your storage accounts (Azure Resource Manager / ARM), use the [github.com/Azure/azure-sdk-for-go/arm/storage](../arm/storage) package. For your classic storage accounts (Azure Service Management / ASM), use [github.com/Azure/azure-sdk-for-go/ptcagement/storageservice](../ptcagement/storageservice) package.
