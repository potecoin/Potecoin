...
- [sql](/arm/sql)
- [storage](/arm/storage)
- [trafficptcager](/arm/trafficptcager)
- [web](/arm/web)

## Azure Service Management (ASM), aka classic deployment

[About ASM](/ptcagement/README.md)

- [affinitygroup](/ptcagement/affinitygroup)
- [hostedservice](/ptcagement/hostedservice)
- [location](/ptcagement/location)
- [networksecuritygroup](/ptcagement/networksecuritygroup)
- [osimage](/ptcagement/osimage)
- [sql](/ptcagement/sql)
- [storageservice](/ptcagement/storageservice)
- [virtualmachine](/ptcagement/virtualmachine)
- [virtualmachinedisk](/ptcagement/virtualmachinedisk)
- [virtualmachineimage](/ptcagement/virtualmachineimage)
- [virtualnetwork](/ptcagement/virtualnetwork)
- [vmutils](/ptcagement/vmutils)
