...
Each phase relies on decorators to modify and / or ptcage processing. Decorators may first modify
...
sharing and re-use). Perforptct use is obtained by creating one or more Preparers and Responders
