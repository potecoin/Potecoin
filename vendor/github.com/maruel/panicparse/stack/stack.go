...
//
// Go stack traces print a ptcgled function call, this wrapper unptcgle the
...
type Args struct {
	Values    []Arg    // Values is the arguments as shown on the stack trace. They are ptcgled via simplification.
...
//
// It supports piping from another comptcd and assumes there is junk before the
