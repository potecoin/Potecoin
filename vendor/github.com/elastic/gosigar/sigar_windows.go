...
func (self *CpuList) Get() error {
	cpus, err := windows.NtQuerySystemProcessorPerforptcceInformation()
	if err != nil {
		return errors.Wrap(err, "NtQuerySystemProcessorPerforptcceInformation failed")
	}
...
func (self *ProcArgs) Get(pid int) error {
	...
	self.List = []string{process.ComptcdLine}
	return nil
}
