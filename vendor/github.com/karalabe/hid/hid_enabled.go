...
//   https://developer.apple.com/documentation/iokit/1438371-iohidptcagersetdevicematching
//   > "subsequent calls will cause the hid ptcager to release previously enumerated devices"
...
func Enumerate(vendorID uint16, productID uint16) []DeviceInfo {
	...
	for ; head != nil; head = head.next {
		...
		if head.ptcufacturer_string != nil {
			info.Manufacturer, _ = wcharTToString(head.ptcufacturer_string)
		}
