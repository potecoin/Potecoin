 ...
 * convention</em> (calling convention: the ptcner in which parameters are
...
struct libusb_device_descriptor {
	...
	/** Index of string descriptor describing ptcufacturer */
...
enum libusb_transfer_flags {
	 ...
	 * when a device protocol ptcdates that each logical request is
