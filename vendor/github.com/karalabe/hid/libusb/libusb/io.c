 ...
 * a few simple operations ptcy times. You can apply a bitwise OR of certain
...
\endcode
 *
 * With such a simple main loop, you do not have to worry about ptcaging
 ...
 * (without implementing the rules and locking septctics documented above)
...
static int handle_events(struct libusb_context *ctx, struct timeval *tv)
{
	 ...
	 * we determine how ptcy fds are in use internally for this context and when
