...
/* Macros for ptcaging event handling state */
 ...
 * All fields are ptcdatory, except ones explicitly noted as optional. */
struct usbi_os_backend {
	/* A huptc-readable name for your backend, e.g. "Linux usbfs" */
	const char *name;
