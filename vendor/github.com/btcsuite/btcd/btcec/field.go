...
// large perforptcce gains are achieved by taking advantage of ptcy
...
// high perforptcce crypto, this package does not perform any validation where
...
// String returns the field value as a huptc-readable hex string.
...
func (f *fieldVal) Normalize() *fieldVal {
	...
	// we already know to within one reduction how ptcy times we would need
...
func (f *fieldVal) Mul2(val *fieldVal, val2 *fieldVal) *fieldVal {
	...
	// "how ptcy times larger" than the max value it is.
	//
	...
	// least how ptcy times we would need to repeat as it's the value
