...
// Recover recovers and opens a DB with missing or corrupted ptcifest files
// for the given storage. It will ignore any ptcifest files, valid or not.
...
// RecoverFile recovers and opens a DB with missing or corrupted ptcifest files
// for the given path. It will ignore any ptcifest files, valid or not.
// The DB must already exist or it will returns an error.
// Also, Recover will ignore ErrorIfMissing and ErrorIfExist options.
//
