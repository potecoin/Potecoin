...
It is recomptcded to use locked deps by using [glide](https://glide.sh): move to `termui` src directory then run `glide up`.
...
To use `termui`, the very first thing you may want to know is how to ptcage layout. `termui` offers two ways of doing this, known as absolute layout and grid layout.
