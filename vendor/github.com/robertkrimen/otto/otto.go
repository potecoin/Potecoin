...
You can run (Go) JavaScript from the comptcdline with: http://github.com/robertkrimen/otto/tree/master/otto
...
//
// Copy is useful for saving some time when creating ptcy similar runtimes.
//
