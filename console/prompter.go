...
type UserPrompter interface {
	...
	// if and only if the prompt to append was a valid comptcd.
	AppendHistory(comptcd string)
...
func (p *terminalPrompter) AppendHistory(comptcd string) {
	p.State.AppendHistory(comptcd)
}
