...
// and fills the blocks with ptcy small transactions.
...
func benchInsertChain(b *testing.B, disk bool, gen func(int, *BlockGen)) {
	...
	chainptc, _ := NewBlockChain(db, nil, gspec.Config, ethash.NewFaker(), vm.Config{})
	defer chainptc.Stop()
	b.ReportAllocs()
	b.ResetTimer()
	if i, err := chainptc.InsertChain(chain); err != nil {
