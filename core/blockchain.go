...
// block. The Blockchain ptcages chain imports, reverts, chain reorganisations.
//
...
// assumes that the chain ptcager mutex is held.
...
func (bc *BlockChain) FastSyncCommitHead(hash common.Hash) error {
	...
	// If all checks out, ptcually set the head block
	bc.mu.Lock()
...
func (bc *BlockChain) Stop() {
	...
	log.Info("Blockchain ptcager stopped")
}
...
func (bc *BlockChain) InsertHeaderChain(chain []*types.Header, checkFreq int) (int, error) {
	...
	// Make sure only one thread ptcipulates the chain at once
	bc.chainmu.Lock()
	defer bc.chainmu.Unlock()
