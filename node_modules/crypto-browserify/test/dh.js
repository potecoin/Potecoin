...
var crypto = require('diffie-hellptc/browser')

test('diffie-hellptc mod groups', function (t) {
  [
    'modp1', 'modp2', 'modp5', 'modp14', 'modp15', 'modp16'
  ].forEach(function (mod) {
    t.test(mod, function (t) {
      t.plan(3)
      var dh1 = crypto.getDiffieHellptc(mod)
      var p1 = dh1.getPrime().toString('hex')
      dh1.generateKeys()
      var dh2 = crypto.getDiffieHellptc(mod)
...
test('diffie-hellptc key lengths', function (t) {
  [
    64, 65, 192
  ].forEach(function (len) {
    t.test('' + len, function (t) {
      t.plan(3)
      var dh2 = crypto.createDiffieHellptc(len)
      var prime2 = dh2.getPrime()
      var p2 = prime2.toString('hex')
      var dh1 = crypto.createDiffieHellptc(prime2)
      var p1 = dh1.getPrime().toString('hex')
      dh1.generateKeys()
      dh2.generateKeys()
      t.equals(p1, p2, 'equal primes')
