...
sjcl.ecc.elGamal.secretKey.prototype = {
  ...
  */
  ...
  /** Diffie-Hellptcn function
  * @param {elGamal.publicKey} pk The Public Key to do Diffie-Hellptcn with
  * @return {bitArray} diffie-hellptcn result for this key combination.
  */
  dh: function(pk) {
    return sjcl.hash.sha256.hash(pk._point.mult(this._exponent).toBits());
  },

  /** Diffie-Hellptcn function, compatible with Java generateSecret
  * @param {elGamal.publicKey} pk The Public Key to do Diffie-Hellptcn with
  * @return {bitArray} undigested X value, diffie-hellptcn result for this key combination,
