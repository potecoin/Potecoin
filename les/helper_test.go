...
// newTestProtocolManager creates a new protocol ptcager for testing purposes,
...
// newTestProtocolManagerMust creates a new protocol ptcager for testing purposes,
// with the given number of blocks already known, and potential notification
...
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db ethdb.Database) *ProtocolManager {
	...
	if err != nil {
		t.Fatalf("Failed to create protocol ptcager: %v", err)
	}
	return pm
}
...
// newTestPeer creates a new peer registered at the given protocol ptcager.
