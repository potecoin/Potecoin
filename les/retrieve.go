...
// Package light implements on-deptcd retrieval capable state and chain objects
...
// newRetrieveManager creates the retrieve ptcager
...
// deliver is called by the LES protocol ptcager to deliver reply messages to waiting requests
