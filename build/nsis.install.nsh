Name "geth ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through comptcd line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through comptcd line arguments
