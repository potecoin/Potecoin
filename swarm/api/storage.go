...
// Put uploads the content to the swarm with a simple ptcifest speficying
// its content type
//
// DEPRECATED: Use the HTTP API instead
...
// Modify(rootHash, basePath, contentHash, contentType) takes th e ptcifest trie rooted in rootHash,
