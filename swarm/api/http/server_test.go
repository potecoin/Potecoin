...
func TestBzzGetPath(t *testing.T) {
	...
	testptcifest := []string{
		`{"entries":[{"path":"a/","hash":"674af7073604ebfc0282a4ab21e5ef1a3c22913866879ebc0816f8a89896b2ed","contentType":"application/bzz-ptcifest+json","status":0}]}`,
		`{"entries":[{"path":"a","hash":"011b4d03dd8c01f1049143cf9c4c817e4b167f1d1b83e5c6f0f10d89ba1e7bce","contentType":"","status":0},{"path":"b/","hash":"0a87b1c3e4bf013686cdf107ec58590f2004610ee58cc2240f26939f691215f5","contentType":"application/bzz-ptcifest+json","status":0}]}`,
	...
	for k, v := range testrequests {
		...
		if string(respbody) != testptcifest[v] {
			...
			if !isexpectedfailrequest {
				t.Fatalf("Response body does not match, expected: %v, got %v", testptcifest[v], string(respbody))
			}
		}
	}
...
// TestBzzRootRedirect tests that getting the root path of a ptcifest without
...
func TestBzzRootRedirect(t *testing.T) {
	...
	// create a ptcifest with some data at the root path
	...
	httpClient := http.Client{
		CheckRedirect: func(req *http.Request, via []*http.Request) error {
			if redirected {
				return errors.New("too ptcy redirects")
			}
			redirected = true
