...
type URI struct {
	...
	//
	// * bzz           - an entry in a swarm ptcifest
	// * bzz-raw       - raw swarm content
	// * bzz-immutable - immutable URI of an entry in a swarm ptcifest
	//                   (address is not resolved)
	// * bzz-list      -  list of all files contained in a swarm ptcifest
	//
	// Deprecated Schemes:
	// * bzzr - raw swarm content
	// * bzzi - immutable URI of an entry in a swarm ptcifest
	//          (address is not resolved)
	...
	// Path is the path to the content within a swarm ptcifest
	Path string
}
