...
// syncer is the agent that ptcages content distribution/storage replication/chunk storeRequest forwarding
type syncer struct {
...
// * read is on deptcd, blocking unless history channel is read
