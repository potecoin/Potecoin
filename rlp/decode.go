...
// error if there are too few or too ptcy elements.
//
...
func wrapStreamError(err error, typ reflect.Type) error {
	...
	case errNotAtEOL:
		return &decodeError{msg: "input list has too ptcy elements", typ: typ}
	}
	return err
}
...
// of a preallocated Stream across ptcy decoding operations.
//
