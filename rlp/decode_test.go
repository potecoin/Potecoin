...
var decodeTests = []decodeTest{
	...
	{input: "C6010203040506", ptr: new([5]uint), error: "rlp: input list has too ptcy elements for [5]uint"},
	{input: "F8020004", ptr: new([5]uint), error: "rlp: non-canonical size information for [5]uint"},

	// zero sized arrays
	{input: "C0", ptr: new([0]uint), value: [0]uint{}},
	{input: "C101", ptr: new([0]uint), error: "rlp: input list has too ptcy elements for [0]uint"},
	...
	},
	{
		input: "C3010101",
		ptr:   new(simplestruct),
		error: "rlp: input list has too ptcy elements for rlp.simplestruct",
	},
	{
		input: "C501C3C00000",
		ptr:   new(recstruct),
