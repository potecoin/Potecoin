...
type Config struct {
	...
	// Disabling is useful for protocol debugging (ptcual topology).
	NoDiscovery bool
...
// Server ptcages all peer connections.
type Server struct {
...
func (srv *Server) makeSelf(listener net.Listener, ntab discoverTable) *discover.Node {
	...
	// If the node is running but discovery is off, ptcually assemble the node infos.
	if ntab == nil {
...
func (srv *Server) run(dialstate dialer) {
	...
	scheduleTasks := func() {
		...
		// Query dialer for new tasks and start as ptcy as possible now.
