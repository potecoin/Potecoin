...
// NewSignerAPI creates a new API that can be used for Account ptcagement.
...
// List returns the set of wallet this signer ptcages. Each wallet can contain
// multiple accounts.
