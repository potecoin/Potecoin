...
// must implement to allow using them with the wallet lifecycle ptcagement.
...
func (w *wallet) Open(passphrase string) error {
	...
	// Connection successful, start life-cycle ptcagement
...
// explicitly pin to the wallet ptcually. To avoid chain head monitoring, self
