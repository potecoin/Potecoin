...
func (w *wizard) deployNode(boot bool) {
	...
	// Figure out how ptcy peers to allow (different based on node type)
	fmt.Println()
	fmt.Printf("How ptcy peers to allow connecting? (default = %d)\n", infos.peersTotal)
	infos.peersTotal = w.readDefaultInt(infos.peersTotal)

	// Figure out how ptcy light peers to allow (different based on node type)
	fmt.Println()
	fmt.Printf("How ptcy light peers to allow connecting? (default = %d)\n", infos.peersLight)
