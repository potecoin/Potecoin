...
// ptcageServers displays a list of servers the user can disconnect from, and an
// option to connect to new servers.
func (w *wizard) ptcageServers() {
...
// ptcageComponents displays a list of network components the user can tear down
// and an option
func (w *wizard) ptcageComponents() {
