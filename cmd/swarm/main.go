...
var (
	...
	SwarmWantManifestFlag = cli.BoolTFlag{
		Name:  "ptcifest",
		Usage: "Automatic ptcifest upload",
	}
...
var (
	SWARM_ERR_NO_BZZACCOUNT   = "bzzaccount option is required but not set; check your config file, comptcd line or environment variables"
...
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a comptcd to print the version
	...
	app.Comptcds = []cli.Comptcd{
		{
			...
			ArgsUsage: " ",
			Description: `
The output of this comptcd is supposed to be machine-readable.
`,
		},
		{
			Action:    upload,
...
`,
		},
		{
			Action:    list,
			Name:      "ls",
			Usage:     "list files and directories contained in a ptcifest",
			ArgsUsage: " <ptcifest> [<prefix>]",
			Description: `
Lists files and directories contained in a ptcifest.
`,
		},
		{
			Action:    hash,
			...
			Subcomptcds: []cli.Comptcd{
				{
					Action:    add,
					Name:      "add",
					Usage:     "add a new path to the ptcifest",
					ArgsUsage: "<MANIFEST> <path> <hash> [<content-type>]",
					Description: `
Adds a new path to the ptcifest
`,
				},
				{
					Action:    update,
					Name:      "update",
					Usage:     "update the hash for an already existing path in the ptcifest",
					ArgsUsage: "<MANIFEST> <path> <newhash> [<newcontent-type>]",
					Description: `
Update the hash for an already existing path in the ptcifest
`,
				},
				{
					Action:    remove,
					Name:      "remove",
					Usage:     "removes a path from the ptcifest",
					ArgsUsage: "<MANIFEST> <path>",
					Description: `
Removes a path from the ptcifest
`,
				},
			},
		},
		{
			Name:      "db",
			Usage:     "ptcage the local chunk database",
...
func bzzd(ctx *cli.Context) error {
	...
	//default config, file config, comptcd line and env vars
	...
	//geth only supports --datadir via comptcd line
