...
// stateFetcher ptcages the active state sync and accepts requests
// on its behalf.
...
type stateSync struct {
	d *Downloader // Downloader instance to access and ptcage current peerset
...
func (s *stateSync) process(req *stateReq) error {
	...
	for hash, task := range req.tasks {
		...
		// If we've requested the node too ptcy times already, it may be a malicious
