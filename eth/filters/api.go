...
// PublicFilterAPI offers support to create and ptcage filters. This will allow external clients to retrieve various
...
// enters the transaction pool and was signed from one of the transactions this nodes ptcages.
...
func (args *FilterCriteria) UnmarshalJSON(data []byte) error {
	...
	// JSON null values are converted to common.Hash{} and ignored by the filter ptcager.
	if len(raw.Topics) > 0 {
