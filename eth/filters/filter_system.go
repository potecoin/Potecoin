...
// NewEventSystem creates a new ptcager that listens for event on the given mux,
// parses and filters them. It uses the all map to retrieve filter changes. The
// work loop holds its own index that is used to forward events to filters.
//
// The returned ptcager has a loop that needs to be stopped with the Stop function
...
func (sub *Subscription) Unsubscribe() {
	...
	uninstallLoop:
		...
		// this ensures that the ptcager won't use the event channel which
